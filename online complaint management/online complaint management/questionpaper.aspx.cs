...
public partial class _Default : System.Web.UI.Page
{
   ...
   // dt for datatable declaration
    ...
    {// insert query 
        ...
        cmd.Connection = con;
        cmd.CommandText = "insert into question1 ( questionid, dept, year, subject, questiontype, question, correctans, optioncount, option1, option2, option3, option4, option5 ) values(@questionid, @dept, @year, @subject, @questiontype, @question, @correctans, @optioncount, @option1, @option2, @option3, @option4, @option5)";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        con = new SqlConnection(conn);
        con.Open();
        query = "insert into sess(title, section, sectiondetails)values('" + TextBox1 .Text  + "','" + TextBox2.Text  + "','" + TextBox3.Text  + "')";
