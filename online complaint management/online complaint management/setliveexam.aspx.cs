...
public partial class asdf : System.Web.UI.Page
{
    ...
    {
        dbconn();
        query = " select questionid from liveexamquestion";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        while (rd.Read())
        {
            ...
            dbconn();
            query = "insert into liveexamset(liveexamid, question, date, dept, studentname, regno, year) values ('" + DropDownList1 .Text + "','" + txtquestion.Text + "', '" + txttime.Text + "','" + txtdept.Text + "','"+ txtstudentname.Text +"','" + txtregno.Text + "','" + txtyear.Text + "')";
            cmd = new SqlCommand(query, con);
            cmd.ExecuteNonQuery();
    ...
    {
        txttime .Text = Calendar1.SelectedDate.ToShortDateString ();
    ...
    {
         dbconn();
        query = " select question from liveexamquestion where questionid ='" + DropDownList1.Text +"'" ;
         cmd = new SqlCommand(query, con);
        rd = cmd.ExecuteReader();
       if  (rd.Read())
        {
            txtquestion.Text = rd[0].ToString();
