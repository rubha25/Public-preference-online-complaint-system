...
public partial class reg : System.Web.UI.Page
{
 ...
 dbconn();
 query = "insert into staff_reg ( staffname, staffid, fathername, age, department, email, password ) values ('" + txtname.Text + "','" + txtregno.Text + "','" + txtfname.Text + "','" + txtage.Text + "','" + txtdept.Text + "','"+ txtemail.Text +"','" + txtpwd.Text + "')";
 ...
 string Body = "UserName " + txtname.Text + ",<p> </p> Password " + txtpwd.Text + "";
 mail.Body = Body;
